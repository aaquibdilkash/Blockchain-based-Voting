...
const App = () => {
  ...
  const loadBlockchainData = async () => {
    ...
    if (networkId == 80001) {
      ...
      const electionContract = new web3.eth.Contract(
        Election.abi,
        "0x9581F15F2C513cb9Aa676fF2a94fE7d8be466eE1"
      );
  ...
  useEffect(() => {
    setrefresh(0);
    loadBlockchainData();
  }, [voted, showlead, addingCandidate]);
    ...
    <div>
      ...
      {account == "" ? (
        <div className="container">
          <h3>
            <center>Connect your wallet to application</center>
          </h3>
          <center>
